...
class App(object):  
	...
	def listen(self):
		""" identical code from winamp_suggest. Monitors the listening by the hour """
...
##				winamp_found = True
	...
	def generateRaffleList(self):
			...
			try:
				distance = 1
				while len(possible_bands) < 10: #go +- 1 hours from now, until there are at least 10 bands to chose from
					if distance >= 12:
						return False
